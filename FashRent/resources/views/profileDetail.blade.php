                    ...
                    @csrf
                        ...
                        <div class="dataProfile">
                            ...
                            <div class="Form">
                                <div class="row mb-3">
                                    <div class="col ">
                                        <label for="namapemilik" class="col-form-label text-md-end">{{ __('Name') }}</label>
                                        <input id="disabledTextInput" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$d->renter_name}}" required autocomplete="name" autofocus>
