...
class insert_data_to_product_table extends Seeder
{
    ...
    public function run()
    {
        DB::table('product')->insert([
            ...
            ['shop_id' => 4, 'category_id' => 6, 'product_name' => 'Sepatu formal', 'product_description' => 'Sepatu hitam coklat kulit', 'product_rentprice' => 20000, 'product_deposito' => 100000, 'product_gender' => 'Pria', 'product_color' => 'hitam',
