...
class insert_data_to_shop_table extends Seeder
{
    ...
    public function run()
    {
        DB::table('shop')->insert([
            ...
            ['shop_id' => '2', 'id' => '3', 'Shop_Address' => 'Jalan Lingkar Boulevar Blok WA No.1', 'Shop_PhoneNumber' => '08123000123', 'Shop_City' => 'Jakarta Selatan', 'Shop_Description' => 'Jual dan sewa macam macam kebaya adat daerah. Menyewakan kebaya dengan kualitas terbaik dan berbagai jenis model kebaya sesaui dengan acara,  untuk acara pernikahan, pre-wedding, wisuda, birthday party, kondangan.'],
            ['shop_id' => '3', 'id' => '4', 'Shop_Address' => 'Jl. Kemanggisan Ilir III No.45', 'Shop_PhoneNumber' => '0878123000', 'Shop_City' => 'Jakarta Pusat', 'Shop_Description' => 'Sewa jas dan setelan pria dan blazer wanita, Koleksi kami up-to-date dan banyak pilihan ukuran, warna dan model. Kamu akan tampan maksimal '],
